...
Готовый слепок рабочей системы: OpenClaw Gateway + 2 кастомных плагина (Jina Search / Jina RAG) + безопасная конфигурация.
Без miniapp, без дайджеста, без календаря. Модель/провайдер — на твой выбор (в конфиге плейсхолдеры).
