...
var grokOgIdentity = { "site": {
	"title": "R2D2",
	"card": "custom",
	"description": "Personal command center — weather, digest, and tasks.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_Tx2tnk = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_Tx2tnk
	};
	return ((_m, p) => {
		return {
			data,
