...
|---|---|---|---|---|---|
| E1 | Активный bot token в git-истории | CONFIRMED | `git log --all -p` → `8675950544:AAG56lRsDsFElbdn_MtMrNYifNRTCszgXQg` (совпадает с openclaw.json) + старый `7963335559:AAFA...` | Git history / Telegram | CRITICAL |
...
- **Finding**: `8675950544:AAG56lRsDsFElbdn_MtMrNYifNRTCszgXQg` — текущий токен бота @Dmbotmy_bot — присутствует в истории git (коммиты 2e2e689, 32d6717 и др.). Репо приватное, но история нестираема.
