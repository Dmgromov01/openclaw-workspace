...
Не ломай работающий Python, пока фаза 2 не пройдёт смоук. Откат: старый юнит + старый `static/index.html`.
...
- Не собирать тяжёлый фронт на 2GB, если уже жмёт OpenClaw — сборка либо с swap, либо артефакт приходит готовый.
